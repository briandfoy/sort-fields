...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Sort-Fields> or 
L<MetaCPAN|http://www.metacpan.org/module/Sort::Fields>:

=over 4

=item *	L<http://search.cpan.org/dist/Sort-Fields>

=item *	L<http://www.metacpan.org/module/Sort::Fields>
